...
GtkWidget *gui_button_with_icon_add( GtkWidget *parent_w, const char *resource_path, const char *label, GCallback callback, void *callback_data );
...
void gui_clist_append_begin( GtkWidget *clist_w );
void gui_clist_append_end( GtkWidget *clist_w );
...
GtkWidget *gui_resource_image_add( GtkWidget *parent_w, const char *resource_path );
